...
## Active Projects
See [project_atlas.md](project_atlas.md) — Atlas migration, in progress.
...
**1. Compress index entries to one line.** A pointer doesn't need a paragraph. `See [topic.md](topic.md) — one-line hook of why future-you will want this.` Anything richer belongs in `topic.md` itself. Aim for ~150 chars per index line; the index is a table of contents, not a summary.
